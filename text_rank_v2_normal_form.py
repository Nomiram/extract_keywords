...
stop_words = ""
with open("stop_words.json", "r", encoding="UTF8") as f:
...
def TextRank_m(text: str):
    ...
    raw_text_rank_keywords2 = keywords.keywords(
        text, language="russian", words=10, additional_stopwords=stop_words).split()
    # text, language="russian", words=10, additional_stopwords=stopwords.words("russian")).split()
